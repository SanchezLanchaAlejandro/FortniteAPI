...
import com.example.fortniteapi.databinding.ActivityPersonajesBinding
...
class PersonajesActivity : AppCompatActivity() {
    ...
    private fun initUI() {
        ...
        adapter = PersonajesAdapter { irDetail(it) }
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (myResponse.isSuccessful) {
                ...
                runOnUiThread {
                    ...
                    adapter.updateList(response.data.filter { it.tipo.tipo == "outfit" })
                }
            } else
                Log.i("personajes", "Error en la API")
        }
    }
    ...
    private fun irDetail(id: String) {
        val intent = Intent(this, DetailPersonajesActivity::class.java)
